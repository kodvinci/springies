...
public class Muscle extends Spring {
	// default values
	private double BETA; // Takes on values between 0 and 1. Fixes wave
							// amplitude
	private double OMEGA = 30; // Speed of oscillation of muscles
	private double PHI = Math.PI / 2; // Can take on 0, Math.PI/2, Math.PI/3,
										// 3*Math.PI/4 radians
	private double ALPHA = 1; // Assumes values between 1 and 0. relative
								// amplitude
