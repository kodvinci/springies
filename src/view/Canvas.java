...
public class Canvas extends JComponent {
    ...
    private static final JFileChooser INPUT_CHOOSER = new JFileChooser(System.getProperties()
     ...
     * 
     * Never called by you directly, instead called by Java runtime when area of screen covered by
    ...
    public void loadEntities() {
        ...
        if (response == JFileChooser.APPROVE_OPTION) {
            f.loadElements(mySimulation, INPUT_CHOOSER.getSelectedFile());
        }
    }
    ...
    public void loadForces() {
        ...
        int response = INPUT_CHOOSER.showOpenDialog(null);
        if (response == JFileChooser.APPROVE_OPTION) {
            f.loadForces(mySimulation, INPUT_CHOOSER.getSelectedFile());
        }
    }
}
